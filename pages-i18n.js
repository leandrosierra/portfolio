...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "about.li_money": "<strong>Honest monetisation.</strong> The catalogue and products are free to browse. Some pages are funded through clearly-labelled advertising and, for some products, optional paid features — never dark patterns.",
      ...
      "privacy.updated": "Last updated: 2 July 2026.",
      ...
      "privacy.p_cookies1": "The sites may display advertising through <strong>Google AdSense</strong> to fund the services. Advertising is clearly separated from editorial content. Where required by law, advertising cookies and similar identifiers are used only after consent.",
      "privacy.p_cookies2": "Google and other third-party advertising vendors may process information from your browser or device to deliver, measure and improve ads. This can include cookies, device identifiers, IP address, user agent, pages viewed, approximate location and prior visits to this site or other websites. In particular:",
      ...
      "privacy.li_ad_consent": "where consent is required, advertising is loaded only after consent, and you can change or withdraw that consent through the consent controls shown on the relevant site;",
      ...
      "privacy.p_use": "We use the limited data above to operate and improve the products, understand which content is useful, respond to your messages, keep the services secure and, where ads are enabled, fund the services through advertising.",
    ...
    fr: {
      ...
      "about.li_money": "<strong>Monétisation honnête.</strong> Le catalogue et les produits sont consultables gratuitement. Certaines pages sont financées par de la publicité clairement identifiée et, pour certains produits, des options payantes — jamais de dark patterns.",
      ...
      "privacy.updated": "Dernière mise à jour : 2 juillet 2026.",
      ...
      "privacy.p_cookies1": "Les sites peuvent afficher de la publicité via <strong>Google AdSense</strong> afin de financer les services. La publicité est clairement séparée du contenu éditorial. Lorsque la loi l'exige, les cookies publicitaires et identifiants similaires ne sont utilisés qu'après consentement.",
      "privacy.p_cookies2": "Google et d'autres fournisseurs publicitaires tiers peuvent traiter des informations issues de votre navigateur ou appareil pour diffuser, mesurer et améliorer les publicités. Cela peut inclure cookies, identifiants d'appareil, adresse IP, user agent, pages consultées, localisation approximative et visites précédentes sur ce site ou d'autres sites. En particulier :",
      ...
      "privacy.li_ad_consent": "lorsque le consentement est requis, la publicité ne se charge qu'après consentement, et vous pouvez modifier ou retirer ce consentement via les contrôles affichés sur le site concerné ;",
      ...
      "privacy.p_use": "Nous utilisons les données limitées ci-dessus pour exploiter et améliorer les produits, comprendre quels contenus sont utiles, répondre à vos messages, sécuriser les services et, lorsque la publicité est activée, financer les services par la publicité.",
